...
def covert_h5(root):
    ...
    for img_dir in tqdm(img_dirs):
        ...
        if is_training:
            path = '/content/drive/MyDrive/thesis/brain_segmentation/models_run/segtran/data/brats/2021train'
        else:
            path = '/content/drive/MyDrive/thesis/brain_segmentation/models_run/segtran/data/brats/2021valid'
